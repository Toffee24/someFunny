    ...
    <transition name="fade">
      <div v-if="!isLogin" class="wrapper">
        <group title="注册页面">
          ...
          <x-input title="密码" type="password" placeholder="请输入6位数字" v-model="password" :min="6" :max="6" required></x-input>
          <x-input title="请确认密码" v-model="password2" type="password" placeholder="请确认密码" :equal-with="password"></x-input>
        </group>
